...
public class GreetingsController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public String retonarOlaMundo (@PathVariable String nome) {
    ...
    @ResponseBody /*descissao da resposta*/
    ...
    @ResponseBody /*decisão da resposta*/
    ...
    @GetMapping(value = "buscaruserid")/*buscar no banco de dados*/
    @ResponseBody /*decisão da resposta*/
    ...
    @GetMapping(value = "buscarPorNome")/*buscar por nome*/
    @ResponseBody /*decisão da resposta*/
